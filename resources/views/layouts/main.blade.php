            ...
            <div class="container-fluid">
                ...
                <form action="{{ route('logout') }}" method="POST">
                    <div class="d-grid gap-2 d-md-flex justify-content-md-end">
                        @csrf
                        @auth()
                            <a class="btn btn-primary" href="{{ route('personal.main.index') }}" role="button">Личный
                                кабинет</a>
                            <input class="btn btn-primary ml-2 mr-2" type="submit" value="Выйти">
                            @if(auth()->user()->role == 0)
                            <a class="btn btn-danger" href="{{ route('admin.main.index') }}" role="button">Админка</a>
                            @endif()
                        @endauth()
